...
gvadetect model=/models/intel/face-detection-0200/FP32/face-detection-0200.xml device=CPU ! \
gvatrack tracking-type=short-term-imageless ! \
gvaclassify model=/models/intel/age-gender-recognition-retail-0013/FP32/age-gender-recognition-retail-0013.xml device=CPU ! \
